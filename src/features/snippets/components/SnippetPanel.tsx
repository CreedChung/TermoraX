  ...
  return (
    <section className="tool-panel snippet-panel">
      <header className="tool-panel__header">
        ...
        <span>{t("snippets.subtitle", { count: controller.state.snippets.length })}</span>
      </header>
            ...
            <div className="snippet-row" key={snippet.id}>
              ...
              <div className="button-row">
                ...
                <button
                  ...
                  onClick={() => void controller.runSnippetOnActiveSession(snippet.id)}
                  type="button"
                >
                  {t("snippets.run")}
                </button>
