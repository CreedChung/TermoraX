...
const messages: Record<AppLocale, MessageSchema> = {
  "zh-CN": {
    ...
    "terminal.closePane": "关闭当前 Pane",
    "terminal.splitVertical": "垂直分屏",
    "terminal.splitHorizontal": "水平分屏",
    "terminal.focusPrimary": "聚焦主 Pane",
    "terminal.focusSecondary": "聚焦副 Pane",
    "terminal.switchSession": "切换会话",
    "terminal.pane.primary": "主 Pane",
    "terminal.pane.secondary": "副 Pane",
    "terminal.pane.active": "已聚焦",
    "terminal.pane.focus": "聚焦",
    ...
    "transfers.status.canceling": "取消中",
    "transfers.status.succeeded": "已完成",
    "transfers.status.failed": "失败",
    "transfers.status.canceled": "已取消",
    "transfers.retry": "重试",
    "transfers.clearCompleted": "清理已完成",
    "transfers.cancel": "取消",
    "transfers.canceling": "取消中",
    "snippets.title": "片段",
    "snippets.subtitle": "{count} 个复用命令",
    "snippets.searchPlaceholder": "搜索名称、命令、标签或说明",
    "snippets.filter.favorite": "仅收藏",
    "snippets.favorite": "收藏",
    "snippets.unfavorite": "取消收藏",
    "snippets.group.all": "全部分组",
    "snippets.empty": "没有匹配的命令片段。",
    "snippets.parameterHint": "使用 {{name}} 形式定义运行前需要填写的参数。",
    "snippets.parameterPrompt": "请输入参数 {name} 的值",
    "snippets.parameterCount": "{count} 个参数",
    "snippets.edit": "编辑",
    "snippets.run": "执行",
    "snippets.delete": "删除",
    ...
    "toolbar.files": "文件",
    "toolbar.logs": "日志",
    "toolbar.commandPalette": "命令面板，按 Ctrl+K",
    "toolbar.settings": "设置",
    "commandPalette.empty": "没有匹配的命令。",
    "trustedHosts.title": "已信任主机",
    "trustedHosts.subtitle": "{count} 条记录",
    "trustedHosts.empty": "当前还没有已信任主机记录。",
    "trustedHosts.close": "关闭",
    "trustedHosts.delete": "移除信任",
    "trustedHosts.trustedAt": "信任时间：{time}",
